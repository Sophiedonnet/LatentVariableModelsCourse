---
title: "Course: Latent variable models "
...
The course is based on a book that we are writing currently. Before the book is ready, you will find  some useful  slides below. Note that I won't always stick to these documents and may change some stuff.  



  * **Chap 1** : Introduction [<i class="fa fa-download"></i>](../Slides/Chap1_PresCours/LVM_pres.pdf)
  * **Chap 2** : mixture models [<i class="fa fa-download"></i>](../Slides/Chap2_LVM_GeneralDef/chap2_LVM_Mixtures.pdf)
