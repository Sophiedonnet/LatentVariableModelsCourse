...
| Chapitre | Slides  | Illustration  | Ressources |
  |:-------------|:-------:|:--------|:------:| 
  | **Presentation**|  [<i class="fa fa-download"></i>](./Ressources/Slides/Chap1_PresCours/LVM_pres_2025.pdf)| | | 
  | **Chap 2** : Explicit E step |  [<i class="fa fa-download"></i>](./Ressources/Slides/Chap2_LVM_GeneralDef/chap2_LVM_Mixtures.pdf)| [Adelie Penguins](./Ressources/IllustrationsRmd/Chap1_MixtureAdelie/Chap1_PalmerPinguins.html)| [Files](./Ressources/IllustrationsRmd/Chap1_MixtureAdelie.zip) | 
  |  |  | [Bohemia Vegetation](./Ressources/IllustrationsRmd/Chap2_1_GaussianMixtureModel/Chap2_1_BohemiaVegetation.html)| [Files](./Ressources/IllustrationsRmd/Chap2_1_GaussianMixtureModel.zip)| 
  ...
  | **Chap 4** : Approximated E step (Variational EM)| [Complete course](https://sophiedonnet.github.io/IntroductionToBlockModels/) [<i class="fa fa-download"></i>](./Ressources/Slides/Chap4_LVM_VariationalE/Slides_SBM_LBM/slides_SBM_LBM_intro/chap4_LVM_SBM_LBM.pdf) |  [Parasitism Ecological network ](https://sophiedonnet.github.io/IntroductionToBlockModels/TP_SBM/TutorialBM.html) |  |
